      ...
      <div className="relative max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          ...
          <div className="space-y-3 text-sm">
            <a href="tel:+919834946893" className="block text-white font-raleway text-lg font-semibold tracking-normal whitespace-nowrap hover:text-rose-200 transition-colors">
              +91 98349 46893
            </a>
