...
export default function BestReadings() {
  return (
    <section className="relative bg-gradient-to-b from-[#FFF8F5] via-[#F7F0FB] to-[#FDE8E8] overflow-hidden">
      {/* Decorative blobs */}
      ...
      <div className="relative max-w-3xl mx-auto px-4 pt-28 pb-14">
        <motion.div
      ...
      {/* Full-bleed image — no px padding, no max-w constraint */}
      <motion.div
